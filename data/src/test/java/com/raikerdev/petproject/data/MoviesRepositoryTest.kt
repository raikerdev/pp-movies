...
class MoviesRepositoryTest {
    ...
    @Test
    fun `Switching favorite mark as favorite an un-favorite movie`(): Unit = runBlocking {
    ...
    @Test
    fun `Switching favorite mark as un-favorite an favorite movie`(): Unit = runBlocking {
